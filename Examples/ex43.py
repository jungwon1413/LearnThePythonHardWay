...
class Scene(object):
	...
	def enter(self):
		print("아직 만들지 않은 장면입니다. 상속에 enter()를 구현하세요.")
		exit(1)
...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "발사!":
			print("당신은 광선총을 뺴들기가 무섭게 고던인을 쏘아버립니다. 광대옷이 날려")
			...
			print("동안 발이 미끄려져 금속 벽이 머리를 치고 기절합니다. 잠시 후 정신을")
			...
			print("하나 합니다.")
			print("Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, hur fvgf nebhaq gur ubhfr.")
